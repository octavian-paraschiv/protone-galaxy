     ...
     translate = false;
        ...
        public static void RegisterTranslationAssembly(Assembly asm)
        {
            if (translate && asm != null && !_assemblies.Contains(asm))
            {
                ...
                ResourceManager resManager = new ResourceManager($"{asmName}.Translations.Translation", asm);
        ...
        public static string TranslatedAppName
        {
            get
            {
                return Translate("TXT_APP_NAME");
            }
        }
